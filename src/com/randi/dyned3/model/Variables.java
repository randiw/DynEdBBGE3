...
public class Variables {
	...
	public static final String CONVERSATION_CODE = "GE3";
	public static final String APP_NAME = "General English 3";
	public static final String APP_ID = "100003";

	public static final String SPLASH_NAME = "General English / 3";
